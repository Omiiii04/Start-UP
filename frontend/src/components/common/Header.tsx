        ...
        <div className="w-full max-w-[1440px] mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center shrink-0">
            ...
            >
              ...
              <div>
                <span className="font-headline font-bold text-base sm:text-2xl text-zinc-900 dark:text-white tracking-tight group-hover:text-black dark:group-hover:text-zinc-100 transition-colors">
                  Project Wallah
                </span>
              </div>
            </button>
